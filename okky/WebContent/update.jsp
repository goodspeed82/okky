...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="updateAction.jsp?okkyID=<%=okkyID %>">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control"
								placeholder="글 제목" name="okkyTitle" maxlength="50" value="<%= okky.getOkkyTitle() %>"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용"
									name="okkyContent" maxlength="2048" style="height: 350px;"><%= okky.getOkkyContent() %></textarea></td>
						</tr>
					</tbody>
				</table>
